...
<div class="sticky-footer-cta">
  <a href="tel:+1234567890" onclick="gtag('event', 'conversion', {'send_to': 'AW-17551570187/qe3NCIyTnPqCEIvqnrFB'});" class="btn btn-secondary sticky-btn">
  ...
  <a href="https://book.squareup.com/appointments/d34rhdcazwo38t/location/L2K4HDPJ9GD77" target="_blank" onclick="gtag('event', 'conversion', {'send_to': 'AW-17551570187/qe3NCIyTnPqCEIvqnrFB'});" rel="noopener noreferrer" class="btn btn-primary sticky-btn">
    BOOK NOW &rarr;
  </a>
</div>
